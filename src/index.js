...
<h1 class="jumbotron text-center" style="margin-bottom:0">Learning Bootstrap 4</h1>
  ...
  <div class="container" style="margin-top:20px">
    ...
    <div class="row">
      ...
      <div class="col-sm-8">
        <h3>Putting Bootstrap to work.</h3>
        <h5>November 27th, 2020</h5>
        <p>This is my learning of <a href="https://getbootstrap.com/" target="_blank">Bootstrap</a>.</p>
